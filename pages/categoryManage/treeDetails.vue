  ...
  <div class="tree-details">
    <el-row type="flex">
      ...
      <el-col style="width: 180px">
        ...
        <el-button
          @click="deleteDepart(data.data.id,$event)"
          type="danger"
          icon="el-icon-delete"
          circle
          size="mini"
...
export default {
  ...
  methods: {
    ...
    info(node, e) {
      ...
      this.$alert(
        '<strong style="margin-right: 18px">分类名称:</strong>' +
          info.name +
          ' <br><br><strong>分类描述:</strong><br><div class="category-description">' +
          (info.comment ? info.comment : '暂无描述') +
          '</div>',
        '分类详情',
        {
          type: 'info',
